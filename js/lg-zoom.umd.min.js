  ...
  return (
    ...
    (h.prototype.getDragAllowedAxises = function (e, t) {
      var o = this.core
        ...
        s = e
          ? ((i = o.offsetHeight * e), o.offsetWidth * e)
          : t
          ? ((i = n.height + t * n.height), n.width + t * n.width)
          : ((i = n.height), n.width),
        o = i > this.containerRect.height;
      return { allowX: s > this.containerRect.width, allowY: o };
    }),
    ...
    (h.prototype.zoomImage = function (e, t, o, i) {
      ...
      Math.abs(t) <= 0 ||
        ...
        (s = (n = this.getDragAllowedAxises(0, t)).allowY),
        (n = n.allowX),
        this.positionChanged &&
          ((a = this.left / (this.scale - t)),
          (r = this.top / (this.scale - t)),
          (this.pageX = l - a),
          (this.pageY = c - r),
        ...
        (c =
          1 < e - t
            ? ((h = (e - t) / Math.abs(t)),
              (g =
                (r = (t < 0 ? -r : r) + this.left * (h + (t < 0 ? -1 : 1))) /
                h),
              (l = (t < 0 ? -l : l) + this.top * (h + (t < 0 ? -1 : 1))) / h)
            : ((g = r * (h = (e - t) * t)), l * h)),
        o &&
          (n
            ? this.isBeyondPossibleLeft(g, a.minX)
              ? (g = a.minX)
              : this.isBeyondPossibleRight(g, a.maxX) && (g = a.maxX)
            : 1 < e && (g < a.minX ? (g = a.minX) : g > a.maxX && (g = a.maxX)),
          s
        ...
        this.setZoomStyles({ x: g, y: c, scale: e }),
        (this.left = g),
        (this.top = c),
    ...
    (h.prototype.setZoomImageSize = function () {
      ...
      setTimeout(function () {
        ...
        t.scale >= e && (o.addClass("no-transition"), (t.imageReset = !0));
      }, 500),
        setTimeout(function () {
          var e = t.getCurrentImageActualSizeScale();
          t.scale >= e &&
            ...
            o
              .css("width", o.get().naturalWidth + "px")
              .css("height", o.get().naturalHeight + "px"),
            t.core.outer.addClass("lg-actual-size"),
            e.allowX && e.allowY
              ? o.addClass("reset-transition")
              : e.allowX && !e.allowY
              ? o.addClass("reset-transition-x")
              : !e.allowX && e.allowY && o.addClass("reset-transition-y"));
        }, 550);
    }),
    ...
    (h.prototype.setActualSize = function (e, o) {
      var i,
        s = this;
      this.zoomInProgress ||
        ...
        setTimeout(function () {
          ...
          i.src &&
            ...
            ((e = s.getCurrentImageActualSizeScale()),
            (t = s.scale),
            ...
            s.setPageCords(o),
            s.beginZoom(s.scale),
            s.zoomImage(s.scale, s.scale - t, !0, !0));
        }, 50),
        setTimeout(function () {
    ...
    (h.prototype.init = function () {
      ...
      this.settings.zoom &&
        ...
        this.core.outer.on("dblclick.lg", function (e) {
          i.$LG(e.target).hasClass("lg-image") &&
            i.setActualSize(i.core.index, e);
        }),
        ...
        this.core.LGel.on(
          ...
          function () {
            ...
            i.core.lgOpened &&
              ...
              (i.left = 0),
              i.setZoomEssentials(),
              i.setZoomSwipeStyles(e, { x: 0, y: 0 }),
              (i.positionChanged = !0));
          }
        ),
        this.$LG(window).on(
          ...
          function () {
            i.core.lgOpened && (i.scrollTop = i.$LG(window).scrollTop());
          }
        ),
        this.core.getElementById("lg-zoom-out").on("click.lg", function () {
          ...
          i.isImageSlide(i.core.index) &&
            ((e = 0),
            i.imageReset && (i.resetImageTranslate(i.core.index), (e = 50)),
            setTimeout(function () {
              var e = i.scale - i.settings.scale;
              i.beginZoom((e = e < 1 ? 1 : e)),
                i.zoomImage(e, -i.settings.scale, !0, !i.settings.infiniteZoom);
            }, e));
        }),
        ...
        this.core.getElementById("lg-actual-size").on("click.lg", function () {
          i.setActualSize(i.core.index);
        }),
        this.core.LGel.on(t + ".zoom", function () {
          i.core.outer.find(".lg-item").removeClass("lg-zoomable");
        }),
        this.core.LGel.on(s + ".zoom", function () {
          (i.scrollTop = i.$LG(window).scrollTop()),
            (i.pageX = i.core.outer.width() / 2),
            (i.pageY = i.core.outer.height() / 2 + i.scrollTop),
            (i.scale = 1);
        }),
        this.core.LGel.on(a + ".zoom", function (e) {
          e = e.detail.prevIndex;
          (i.scale = 1),
            (i.positionChanged = !1),
            (i.zoomInProgress = !1),
            i.resetZoom(e),
            i.resetImageTranslate(e),
            i.isImageSlide(i.core.index) && i.setZoomEssentials();
        }),
        this.zoomDrag(),
        this.pinchZoom(),
        this.zoomSwipe(),
    ...
    (h.prototype.pinchZoom = function () {
      ...
      this.core.outer.on("touchstart.lg", function (e) {
        (a = o.core.getSlideItem(o.core.index)),
          o.isImageSlide(o.core.index) &&
            2 === e.touches.length &&
            (e.preventDefault(),
            o.core.outer.hasClass("lg-first-slide-loading") ||
              ((n = o.scale || 1),
              o.core.outer.removeClass(
                "lg-zoom-drag-transition lg-zoom-dragging"
              ),
              o.setPageCords(e),
              o.resetImageTranslate(o.core.index),
              (o.core.touchAction = "pinch"),
              (i = o.getTouchDistance(e))));
      }),
        this.core.$inner.on("touchmove.lg", function (e) {
          2 === e.touches.length &&
            "pinch" === o.core.touchAction &&
            (o.$LG(e.target).hasClass("lg-item") ||
              a.get().contains(e.target)) &&
            (e.preventDefault(),
            (e = o.getTouchDistance(e)),
            (e = i - e),
            (s = !s && 5 < Math.abs(e) ? !0 : s) &&
              ((t = o.scale),
              (e = Math.max(1, n + 0.02 * -e)),
              (o.scale = Math.round(100 * (e + Number.EPSILON)) / 100),
              (e = o.scale - t),
              o.zoomImage(
                o.scale,
        ...
        this.core.$inner.on("touchend.lg", function (e) {
          ...
          "pinch" === o.core.touchAction &&
            ...
            o.scale <= 1
              ? o.resetZoom()
              : ((e = o.getCurrentImageActualSizeScale()),
                o.scale >= e &&
                  ((t = e - o.scale),
                  o.zoomImage(e, (t = 0 === t ? 0.01 : t), !1, !0)),
                o.manageActualPixelClassNames(),
                o.core.outer.addClass("lg-zoomed")),
    ...
    (h.prototype.touchendZoom = function (e, t, o, i, s) {
      var n = t.x - e.x,
        ...
        e =
          ...
          (n *= e),
          (t *= s),
          this.core.getSlideItem(this.core.index).find(".lg-img-wrap").first()),
        s = {},
        a =
          ((s.x = this.left + n),
          (s.y = this.top + t),
          this.getPossibleSwipeDragCords());
      (15 < Math.abs(n) || 15 < Math.abs(t)) &&
        (i &&
          (this.isBeyondPossibleTop(s.y, a.minY)
            ? (s.y = a.minY)
            : this.isBeyondPossibleBottom(s.y, a.maxY) && (s.y = a.maxY)),
        o &&
          (this.isBeyondPossibleLeft(s.x, a.minX)
            ? (s.x = a.minX)
            : this.isBeyondPossibleRight(s.x, a.maxX) && (s.x = a.maxX)),
        i ? (this.top = s.y) : (s.y = this.top),
        o ? (this.left = s.x) : (s.x = this.left),
        this.setZoomSwipeStyles(e, s),
    ...
    (h.prototype.getZoomSwipeCords = function (e, t, o, i, s) {
      ...
      return (
        i
          ? ((n.y = this.top + (t.y - e.y)),
            this.isBeyondPossibleTop(n.y, s.minY)
              ? ((i = s.minY - n.y), (n.y = s.minY - i / 6))
              : this.isBeyondPossibleBottom(n.y, s.maxY) &&
                ((i = n.y - s.maxY), (n.y = s.maxY + i / 6)))
          : (n.y = this.top),
        o
          ? ((n.x = this.left + (t.x - e.x)),
            this.isBeyondPossibleLeft(n.x, s.minX)
              ? ((i = s.minX - n.x), (n.x = s.minX - i / 6))
              : this.isBeyondPossibleRight(n.x, s.maxX) &&
                ((o = n.x - s.maxX), (n.x = s.maxX + o / 6)))
          : (n.x = this.left),
        n
      );
    }),
    ...
    (h.prototype.getPossibleSwipeDragCords = function (e) {
      ...
      return (
        e && ((i += e * i), (t += e * t)),
        {
          minY: (i - this.containerRect.height) / 2,
          maxY: (this.containerRect.height - i) / 2 + o,
    ...
    (h.prototype.zoomSwipe = function () {
      ...
      this.core.$inner.on("touchstart.lg", function (e) {
        ...
        s.isImageSlide(s.core.index) &&
          ...
          (s.$LG(e.target).hasClass("lg-item") || c.get().contains(e.target)) &&
            1 === e.touches.length &&
            s.core.outer.hasClass("lg-zoomed") &&
            (e.preventDefault(),
            (g = new Date()),
            ...
            (i = s.core
              ...
              .find(".lg-img-wrap")
              .first()),
            (t = s.getDragAllowedAxises(0)),
            (l = t.allowY),
            ((r = t.allowX) || l) && (n = s.getSwipeCords(e)),
            (o = s.getPossibleSwipeDragCords()),
            s.core.outer.addClass("lg-zoom-dragging lg-zoom-drag-transition")));
      }),
        this.core.$inner.on("touchmove.lg", function (e) {
          1 === e.touches.length &&
            ...
            (s.core.touchAction = "zoomSwipe"),
            (t = s.getSwipeCords(e)),
            (e = s.getZoomSwipeCords(n, t, r, l, o)),
            (15 < Math.abs(t.x - n.x) || 15 < Math.abs(t.y - n.y)) &&
              ((a = !0), s.setZoomSwipeStyles(i, e)));
        }),
        this.core.$inner.on("touchend.lg", function (e) {
          "zoomSwipe" === s.core.touchAction &&
            (s.$LG(e.target).hasClass("lg-item") ||
            ...
            a &&
              ((a = !1),
              (e = new Date().valueOf() - g.valueOf()),
              s.touchendZoom(n, t, r, l, e)));
        });
    }),
    (h.prototype.zoomDrag = function () {
      ...
      this.core.outer.on("mousedown.lg.zoom", function (e) {
        ...
        n.isImageSlide(n.core.index) &&
          ((t = n.core.getSlideItem(n.core.index)),
          (n.$LG(e.target).hasClass("lg-item") || t.get().contains(e.target)) &&
            ((o = new Date()),
            (s = n.core
            ...
            n.core.outer.hasClass("lg-zoomed") &&
              n.$LG(e.target).hasClass("lg-object") &&
              (c || h) &&
              (e.preventDefault(),
              (a = n.getDragCords(e)),
        ...
        this.$LG(window).on(
          ...
          function (e) {
            l &&
              ((g = !0),
              (r = n.getDragCords(e)),
              (e = n.getZoomSwipeCords(a, r, c, h, i)),
              n.setZoomSwipeStyles(s, e));
          }
        ),
        this.$LG(window).on(
          ...
          function (e) {
            l &&
              ...
              !g ||
                (a.x === r.x && a.y === r.y) ||
                ((r = n.getDragCords(e)),
                (e = t.valueOf() - o.valueOf()),
                n.touchendZoom(a, r, c, h, e)),
              (g = !1)),
